...
public class PaleoclusiaPlant implements Plant {
    @Override
    public PlantBlock createBlock() {
        return new DoublePlantBlock("paleoclusia").withSpawner(PlantSpawner.DOUBLE_GROUND).withBounds(PlantBlock.DOUBLE);
    }
